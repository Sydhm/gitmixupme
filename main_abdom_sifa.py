...
class SIFA_pytorch(nn.Module):
    def __init__(self, config):
        ...
        all_optim = [self.optimizer_DA, self.optimizer_DB, self.optimizer_GA, self.optimizer_GB, self.optimizer_DP, self.optimizer_DP_ll, self.optimizer_Seg]
...
#################################################################### train model ########################################################################
    ...
    def train_model(self):
        ...
        trainset = abdom_dataset(self._train_pth)
